...
<title><?php $this->archiveTitle(array(
        ...
        'tag'       =>  _t('标签 %s 下的文章'),
        'author'    =>  _t('%s 发布的文章')
    ), '', ' | '); ?><?php $this->options->title(); ?><?php if($this->is('index')){echo " | 四川大学.NET协会"; }?></title>
    ...
    <div class="container" id="top">
            <div class="grid-1-4">
                <hgroup id="logo">
                    ...
                    <h2>Love what you do, and you'll do it well</h2>
                </hgroup>      
            </div>
    </div>
    <div id="menu-bar">
        <div class="container">
            <nav id="nav-menu" class="clearfix" role="navigation">
                ...
                <?php if($this->user->hasLogin()): ?>
                  <a href="<?php $this->options->adminUrl(); ?>"><?php _e('控制台'); ?> (<?php $this->user->screenName(); ?>)</a>
                <?php else: ?>
                    <a href="<?php $this->options->adminUrl('login.php'); ?>"><?php _e('登录'); ?></a>
                    <a href="<?php $this->options->adminUrl('register.php'); ?>"><?php _e('注册'); ?></a>
                <?php endif; ?>
